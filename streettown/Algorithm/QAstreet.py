...
def load_user_data(scene):
    ...
    if scenename == '社区服务':
        directory = "/chatgpt/LLMs-QA-system/streettown/Data/街镇助手/社区服务/"
    elif scenename == '社区发展':
        directory = "/chatgpt/LLMs-QA-system/streettown/Data/街镇助手/社区发展/"
    elif scenename == '社区管理':
        directory = "/chatgpt/LLMs-QA-system/streettown/Data/街镇助手/社区管理/"
    elif scenename == '社区平安':
        directory = "/chatgpt/LLMs-QA-system/streettown/Data/街镇助手/社区平安/"
    elif scenename == '社区自治':
        directory = "/chatgpt/LLMs-QA-system/streettown/Data/街镇助手/社区自治/"
    # 检查directory是否已经赋值
...
def load_all_data():
    global scene_data
    scenes = ['社区服务', '社区发展', '社区管理', '社区平安', '社区自治']
    for scene in scenes:
...
def get_answer(query, scenename, reset=False):
    ...
    with open("/chatgpt/LLMs-QA-system/streettown/Algorithm/QAstreet.json", 'a', encoding='utf-8') as f:
